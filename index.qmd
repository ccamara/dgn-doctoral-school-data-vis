...
format: 
  revealjs:
    ...
    footer: https://ccamara.github.io/dgn-doctoral-school-data-vis/
    transition: slide
...
##  {.center background-color="#000" data-menu-title="You found a dinosaur!"}

![You found a dinosaur! (I promised!)](assets/datasaurus_matrix.png)
...
ggplot(aes(x = x, y = y, color = category, alpha = opacity)) +
  geom_point()
```
...
-   Our World in Data: <https://ourworldindata.org/data> (Poverty and development, Food, Energy, Health, Human Rights...at country level)

-   London Data Store: <https://data.london.gov.uk/dataset/> (you can use this [exploration tool](https://data.london.gov.uk/london-area-profiles/) or [this pre-cooked `.csv` file](https://github.com/ccamara/dgn-doctoral-school-data-vis/blob/main/data/london-borough-profilesV3.csv))
